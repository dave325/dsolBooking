...
namespace WPDataAccess\Backup {
	...
	class WPDA_Data_Export {
		...
		public function create_export( $action ) {
			...
			<div class="wrap">
				<h1 class="wp-heading-inline">
					...
					<a href="https://wpdataaccess.com/docs/documentation/data-explorer/scheduled-exports/" target="_blank" title="Plugin Help - open a new tab or window">
				...
				<div id="wpda_export_import">
					<div class="wpda_export_import">
						<form id="wpda_export_import_form" action="?page=wpda&page_action=wpda_backup&schema_name=<?php echo esc_attr( $schema_name ); ?>" method="post"
		...
		public function show_wp_cron() {
			...
			echo '<a href="https://wpdataaccess.com/docs/documentation/data-explorer/scheduled-exports/" target="_blank" title="Plugin Help - open a new tab or window">';
			echo '<span class="dashicons dashicons-editor-help "style="text-decoration:none;vertical-align:top;font-size:36px;">';
			echo '</span></a>&nbsp;';
			echo '</h1>';
			echo '<form method="post" action="?page=wpda&page_action=wpda_backup&schema_name=' . esc_attr( $schema_name ) . '" style="display: inline-block; vertical-align: bottom;">';
