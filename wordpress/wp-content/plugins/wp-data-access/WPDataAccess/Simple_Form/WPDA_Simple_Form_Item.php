	...
	class WPDA_Simple_Form_Item {
		...
		protected function show_item() {
			...
			<input name="<?php echo esc_attr( $this->item_name ); ?>"
				   ...
				   type="text"
				   value="<?php echo $this->show_context_column_value; ?>"
				   class="wpda_data_type_<?php echo esc_attr( $this->data_type ); ?> <?php echo esc_attr( $this->show_context_class_primary_key ); ?> <?php echo esc_attr( $this->item_class ); ?> <?php if ( 'NO' === $this->is_nullable && ! $this->is_auto_increment ) {
				       echo 'wpda_not_null';
			       } ?>"
