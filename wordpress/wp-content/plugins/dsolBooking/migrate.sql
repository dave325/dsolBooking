...
-- 4. bookaroom_dsol_booking_time
	INSERT INTO wp_dsol_booking_time (start_time, end_time, res_id) 
        ...
        INNER JOIN wp_bookaroom_roomConts_members m 
        ON bt.ti_roomID = m.rcm_roomID;
    
-- 5. bookroom_dsol_booking_reservation
INSERT INTO wp_dsol_booking_reservation (c_id, t_id, modified_by, created_at, modified_at, created_by, company_name, email, attendance, notes) 
